 ...
 * 
 * @export
 * @interface GenerateApiTokenResponse
 */
export interface GenerateApiTokenResponse {
    /**
     * 
     * @type {number}
     * @memberof GenerateApiTokenResponse
     */
    apiKeyId: number;
    /**
     * 
...
/**
 * Check if a given object implements the GenerateApiTokenResponse interface.
 */
export function instanceOfGenerateApiTokenResponse(value: object): boolean {
    let isInstance = true;
...
export function GenerateApiTokenResponseFromJSON(json: any): GenerateApiTokenResponse {
    return GenerateApiTokenResponseFromJSONTyped(json, false);
}

export function GenerateApiTokenResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenerateApiTokenResponse {
...
export function GenerateApiTokenResponseToJSON(value?: GenerateApiTokenResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
